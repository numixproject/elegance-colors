class EleganceColorsWindow : Gtk.ApplicationWindow {
    ...
    Gtk.RadioButton match_wallpaper;
    Gtk.RadioButton match_theme;
    Gtk.RadioButton custom_color;
    Gtk.RadioButton text_auto;
    Gtk.RadioButton text_color;

    Gtk.ColorButton color_button;
    Gtk.ColorButton text_button;

    Gtk.FontButton font_button;

    Gtk.Switch dropshadow_switch;

    Gtk.SpinButton selgradient_size;
    Gtk.SpinButton corner_roundness;
    Gtk.SpinButton transition_duration;
    ...
    // Panel
    Gtk.ColorButton panel_bg1_color;
    Gtk.ColorButton panel_bg2_color;
    Gtk.ColorButton panel_fg_color;
    Gtk.ColorButton panel_border_color;

    Gtk.Switch panel_icon_switch;

    Gtk.SpinButton panel_tint_value;
    Gtk.SpinButton panel_bwidth_value;
    ...
    // Overview
    Gtk.ColorButton overview_searchbg1_color;
    Gtk.ColorButton overview_searchbg2_color;
    Gtk.ColorButton overview_searchfocusbg1_color;
    Gtk.ColorButton overview_searchfocusbg2_color;
    Gtk.ColorButton overview_searchfg_color;
    Gtk.ColorButton overview_searchfocusfg_color;
    Gtk.ColorButton overview_searchborder_color;
    Gtk.ColorButton overview_searchfocusborder_color;
    ...
    // Dash
    Gtk.ColorButton dash_bg1_color;
    Gtk.ColorButton dash_bg2_color;
    Gtk.ColorButton dash_fg_color;
    Gtk.ColorButton dash_border_color;

    Gtk.SpinButton dash_tint_value;
    Gtk.SpinButton dash_bwidth_value;
    ...
    // Menu
    Gtk.ColorButton menu_bg1_color;
    Gtk.ColorButton menu_bg2_color;
    Gtk.ColorButton menu_fg_color;
    Gtk.ColorButton menu_border_color;

    Gtk.Switch menu_arrow_switch;

    Gtk.SpinButton menu_tint_value;
    Gtk.SpinButton menu_bwidth_value;
    ...
    // Dialogs
    Gtk.ColorButton dialog_bg1_color;
    Gtk.ColorButton dialog_bg2_color;
    Gtk.ColorButton dialog_fg_color;
    Gtk.ColorButton dialog_heading_color;
    Gtk.ColorButton dialog_border_color;

    Gtk.SpinButton dialog_tint_value;
    Gtk.SpinButton dialog_bwidth_value;
    ...
    // Gtk.Buttons
    Gtk.ColorButton button_bg1_color;
    Gtk.ColorButton button_bg2_color;
    Gtk.ColorButton button_hoverbg1_color;
    Gtk.ColorButton button_hoverbg2_color;
    Gtk.ColorButton button_activebg1_color;
    Gtk.ColorButton button_activebg2_color;
    Gtk.ColorButton button_fg_color;
    Gtk.ColorButton button_hoverfg_color;
    Gtk.ColorButton button_activefg_color;
    Gtk.ColorButton button_border_color;
    Gtk.ColorButton button_hoverborder_color;
    Gtk.ColorButton button_activeborder_color;

    Gtk.Switch button_bold_switch;
    ...
    // Focused buttons
    Gtk.ColorButton buttonfocus_bg1_color;
    Gtk.ColorButton buttonfocus_bg2_color;
    Gtk.ColorButton buttonfocus_hoverbg1_color;
    Gtk.ColorButton buttonfocus_hoverbg2_color;
    Gtk.ColorButton buttonfocus_activebg1_color;
    Gtk.ColorButton buttonfocus_activebg2_color;
    Gtk.ColorButton buttonfocus_fg_color;
    Gtk.ColorButton buttonfocus_hoverfg_color;
    Gtk.ColorButton buttonfocus_activefg_color;
    Gtk.ColorButton buttonfocus_border_color;
    Gtk.ColorButton buttonfocus_hoverborder_color;
    Gtk.ColorButton buttonfocus_activeborder_color;
    ...
    // Entry
    Gtk.ColorButton entry_bg1_color;
    Gtk.ColorButton entry_bg2_color;
    Gtk.ColorButton entry_fg_color;
    Gtk.ColorButton entry_border_color;

    Gtk.Switch entry_shadow_switch;
    ...
    // Misc
    Gtk.ColorButton misc_runningbg1_color;
    Gtk.ColorButton misc_runningbg2_color;
    Gtk.ColorButton misc_separator1_color;
    Gtk.ColorButton misc_separator2_color;
    Gtk.ColorButton misc_tooltipbg1_color;
    Gtk.ColorButton misc_tooltipbg2_color;
    Gtk.ColorButton misc_tooltipfg_color;
    Gtk.ColorButton misc_tooltipborder_color;
    Gtk.ColorButton misc_insensitive_color;
    ...
    internal EleganceColorsWindow (EleganceColorsPref app) {
        ...
        // Set window icon
        try {
            this.icon = Gtk.IconTheme.get_default ().load_icon ("elegance-colors", 48, 0);
        } catch (Error e) {
    ...
    void create_widgets () {
        ...
        // General
        var presets_label = new Gtk.Label.with_mnemonic ("Load config from preset");
        ...
        var mode_label = new Gtk.Label.with_mnemonic ("Derive color from");
        mode_label.set_halign (Gtk.Align.START);
        match_wallpaper = new Gtk.RadioButton (null);
        ...
        match_theme = new Gtk.RadioButton.with_label (match_wallpaper.get_group (), "GTK theme");
        match_theme.set_mode (false);
        match_theme.set_tooltip_text ("Derive the highlight color from the current GTK theme");
        custom_color = new Gtk.RadioButton.with_label (match_theme.get_group (), "Custom");
        ...
        var text_label = new Gtk.Label.with_mnemonic ("Highlight text color");
        text_label.set_halign (Gtk.Align.START);
        text_auto = new Gtk.RadioButton (null);
        ...
        text_color = new Gtk.RadioButton.with_label (text_auto.get_group (), "Custom");
        text_color.set_mode (false);
        text_color.set_tooltip_text ("Manually set a custom highlight text color");
        text_button = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) text_button).set_use_alpha (true);
        text_button.set_tooltip_text ("Set a custom highlight text color");
        var font_label = new Gtk.Label.with_mnemonic ("Display font");
        ...
        var dropshadow_label = new Gtk.Label.with_mnemonic ("Drop shadows");
        dropshadow_label.set_halign (Gtk.Align.START);
        dropshadow_switch = new Gtk.Switch ();
        dropshadow_switch.set_tooltip_text ("Enable/disable drop shadows");
        dropshadow_switch.set_halign (Gtk.Align.END);
        var selgradient_label = new Gtk.Label.with_mnemonic ("Highlight gradient size");
        selgradient_label.set_halign (Gtk.Align.START);
        selgradient_size = new Gtk.SpinButton.with_range (0, 255, 1);
        selgradient_size.set_tooltip_text ("Set the gradient size for highlight color");
        selgradient_size.set_halign (Gtk.Align.END);
        var roundness_label = new Gtk.Label.with_mnemonic ("Roundness");
        roundness_label.set_halign (Gtk.Align.START);
        corner_roundness = new Gtk.SpinButton.with_range (0, 100, 1);
        corner_roundness.set_tooltip_text ("Set the border radius of various elements");
        corner_roundness.set_halign (Gtk.Align.END);
        var transition_label = new Gtk.Label.with_mnemonic ("Transition duration");
        transition_label.set_halign (Gtk.Align.START);
        transition_duration = new Gtk.SpinButton.with_range (0, 1000, 1);
        transition_duration.set_tooltip_text ("Set the duration of the transition animations");
        transition_duration.set_halign (Gtk.Align.END);

        var colorbox = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        colorbox.set_halign (Gtk.Align.END);
        ...
        textbox.set_halign (Gtk.Align.END);
        ...
        general_grid.attach_next_to (combobox, presets_label, Gtk.PositionType.RIGHT, 2, 1);
        general_grid.attach (mode_label, 0, 1, 1, 1);
        general_grid.attach_next_to (colorbox, mode_label, Gtk.PositionType.RIGHT, 2, 1);
        general_grid.attach (text_label, 0, 2, 1, 1);
        general_grid.attach_next_to (textbox, text_label, Gtk.PositionType.RIGHT, 2, 1);
        general_grid.attach (font_label, 0, 3, 1, 1);
        general_grid.attach_next_to (font_button, font_label, Gtk.PositionType.RIGHT, 2, 1);
        general_grid.attach (dropshadow_label, 0, 4, 2, 1);
        general_grid.attach_next_to (dropshadow_switch, dropshadow_label, Gtk.PositionType.RIGHT, 1, 1);
        general_grid.attach (selgradient_label, 0, 5, 2, 1);
        general_grid.attach_next_to (selgradient_size, selgradient_label, Gtk.PositionType.RIGHT, 1, 1);
        general_grid.attach (roundness_label, 0, 6, 2, 1);
        general_grid.attach_next_to (corner_roundness, roundness_label, Gtk.PositionType.RIGHT, 1, 1);
        general_grid.attach (transition_label, 0, 7, 2, 1);
        general_grid.attach_next_to (transition_duration, transition_label, Gtk.PositionType.RIGHT, 1, 1);

        // Panel
        var panel_bg_label = new Gtk.Label.with_mnemonic ("Background gradient");
        panel_bg_label.set_halign (Gtk.Align.START);
        panel_bg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) panel_bg1_color).set_use_alpha (true);
        panel_bg1_color.set_tooltip_text ("Set the background gradient start of the top panel");
        panel_bg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) panel_bg2_color).set_use_alpha (true);
        panel_bg2_color.set_tooltip_text ("Set the background gradient end of the top panel");
        var panel_fg_label = new Gtk.Label.with_mnemonic ("Text color");
        panel_fg_label.set_halign (Gtk.Align.START);
        panel_fg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) panel_fg_color).set_use_alpha (true);
        panel_fg_color.set_tooltip_text ("Set the text color of the top panel");
        var panel_border_label = new Gtk.Label.with_mnemonic ("Border color");
        panel_border_label.set_halign (Gtk.Align.START);
        panel_border_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) panel_border_color).set_use_alpha (true);
        panel_border_color.set_tooltip_text ("Set the border color of the top panel");
        var panel_icon_label = new Gtk.Label.with_mnemonic ("App icon");
        panel_icon_label.set_halign (Gtk.Align.START);
        panel_icon_switch = new Gtk.Switch ();
        panel_icon_switch.set_tooltip_text ("Enable/disable app icon in the top panel");
        panel_icon_switch.set_halign (Gtk.Align.END);
        var panel_tint_label = new Gtk.Label.with_mnemonic ("Background tint level");
        panel_tint_label.set_halign (Gtk.Align.START);
        panel_tint_value = new Gtk.SpinButton.with_range (0, 100, 1);
        ...
        panel_tint_value.set_halign (Gtk.Align.END);
        var panel_bwidth_label = new Gtk.Label.with_mnemonic ("Border width");
        panel_bwidth_label.set_halign (Gtk.Align.START);
        panel_bwidth_value = new Gtk.SpinButton.with_range (0, 100, 1);
        panel_bwidth_value.set_tooltip_text ("Set the width of the border of the top panel");
        panel_bwidth_value.set_halign (Gtk.Align.END);

        var panel_bg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        panel_grid.attach_next_to (panel_bg_box, panel_bg_label, Gtk.PositionType.RIGHT, 1, 1);
        panel_grid.attach (panel_fg_label, 0, 1, 2, 1);
        panel_grid.attach_next_to (panel_fg_color, panel_fg_label, Gtk.PositionType.RIGHT, 1, 1);
        panel_grid.attach (panel_border_label, 0, 2, 2, 1);
        panel_grid.attach_next_to (panel_border_color, panel_border_label, Gtk.PositionType.RIGHT, 1, 1);
        panel_grid.attach (panel_icon_label, 0, 3, 2, 1);
        panel_grid.attach_next_to (panel_icon_switch, panel_icon_label, Gtk.PositionType.RIGHT, 1, 1);
        panel_grid.attach (panel_tint_label, 0, 4, 2, 1);
        panel_grid.attach_next_to (panel_tint_value, panel_tint_label, Gtk.PositionType.RIGHT, 1, 1);
        panel_grid.attach (panel_bwidth_label, 0, 5, 2, 1);
        panel_grid.attach_next_to (panel_bwidth_value, panel_bwidth_label, Gtk.PositionType.RIGHT, 1, 1);

        // Overview
        var overview_searchbg_label = new Gtk.Label.with_mnemonic ("Search entry gradient");
        overview_searchbg_label.set_halign (Gtk.Align.START);
        overview_searchbg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) overview_searchbg1_color).set_use_alpha (true);
        overview_searchbg1_color.set_tooltip_text ("Set the background gradient start of the search entry");
        overview_searchbg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) overview_searchbg2_color).set_use_alpha (true);
        overview_searchbg2_color.set_tooltip_text ("Set the background gradient end of the search entry");
        var overview_searchfocusbg_label = new Gtk.Label.with_mnemonic ("Focused search entry gradient");
        overview_searchfocusbg_label.set_halign (Gtk.Align.START);
        overview_searchfocusbg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) overview_searchfocusbg1_color).set_use_alpha (true);
        overview_searchfocusbg1_color.set_tooltip_text ("Set the background gradient start of the search entry in focus state");
        overview_searchfocusbg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) overview_searchfocusbg2_color).set_use_alpha (true);
        overview_searchfocusbg2_color.set_tooltip_text ("Set the background gradient end of the search entry in focus state");
        var overview_searchfg_label = new Gtk.Label.with_mnemonic ("Search entry text color");
        overview_searchfg_label.set_halign (Gtk.Align.START);
        overview_searchfg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) overview_searchfg_color).set_use_alpha (true);
        overview_searchfg_color.set_tooltip_text ("Set the text color of the search entry");
        var overview_searchfocusfg_label = new Gtk.Label.with_mnemonic ("Focused search entry text color");
        overview_searchfocusfg_label.set_halign (Gtk.Align.START);
        overview_searchfocusfg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) overview_searchfocusfg_color).set_use_alpha (true);
        overview_searchfocusfg_color.set_tooltip_text ("Set the text color of the search entry in focus state");
        var overview_searchborder_label = new Gtk.Label.with_mnemonic ("Search entry border color");
        overview_searchborder_label.set_halign (Gtk.Align.START);
        overview_searchborder_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) overview_searchborder_color).set_use_alpha (true);
        overview_searchborder_color.set_tooltip_text ("Set the border color of the search entry");
        var overview_searchfocusborder_label = new Gtk.Label.with_mnemonic ("Focused search entry border color");
        overview_searchfocusborder_label.set_halign (Gtk.Align.START);
        overview_searchfocusborder_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) overview_searchfocusborder_color).set_use_alpha (true);
        overview_searchfocusborder_color.set_tooltip_text ("Set the border color of the search entry in focus state");

        var overview_searchbg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        var overview_searchfocusbg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        overview_grid.attach_next_to (overview_searchbg_box, overview_searchbg_label, Gtk.PositionType.RIGHT, 1, 1);
        overview_grid.attach (overview_searchfocusbg_label, 0, 1, 2, 1);
        overview_grid.attach_next_to (overview_searchfocusbg_box, overview_searchfocusbg_label, Gtk.PositionType.RIGHT, 1, 1);
        overview_grid.attach (overview_searchfg_label, 0, 2, 2, 1);
        overview_grid.attach_next_to (overview_searchfg_color, overview_searchfg_label, Gtk.PositionType.RIGHT, 1, 1);
        overview_grid.attach (overview_searchfocusfg_label, 0, 3, 2, 1);
        overview_grid.attach_next_to (overview_searchfocusfg_color, overview_searchfocusfg_label, Gtk.PositionType.RIGHT, 1, 1);
        overview_grid.attach (overview_searchborder_label, 0, 4, 2, 1);
        overview_grid.attach_next_to (overview_searchborder_color, overview_searchborder_label, Gtk.PositionType.RIGHT, 1, 1);
        overview_grid.attach (overview_searchfocusborder_label, 0, 5, 2, 1);
        overview_grid.attach_next_to (overview_searchfocusborder_color, overview_searchfocusborder_label, Gtk.PositionType.RIGHT, 1, 1);

        // Dash
        var dash_bg_label = new Gtk.Label.with_mnemonic ("Background gradient");
        dash_bg_label.set_halign (Gtk.Align.START);
        dash_bg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) dash_bg1_color).set_use_alpha (true);
        dash_bg1_color.set_tooltip_text ("Set the background gradient start of the dash and workspace panel");
        dash_bg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) dash_bg2_color).set_use_alpha (true);
        dash_bg2_color.set_tooltip_text ("Set the background gradient end of the dash and workspace panel");
        var dash_fg_label = new Gtk.Label.with_mnemonic ("Text color");
        dash_fg_label.set_halign (Gtk.Align.START);
        dash_fg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) dash_fg_color).set_use_alpha (true);
        dash_fg_color.set_tooltip_text ("Set the text color of the dash labels and window caption");
        var dash_border_label = new Gtk.Label.with_mnemonic ("Border color");
        dash_border_label.set_halign (Gtk.Align.START);
        dash_border_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) dash_border_color).set_use_alpha (true);
        dash_border_color.set_tooltip_text ("Set the border color of the dash and workspace panel");
        var dash_tint_label = new Gtk.Label.with_mnemonic ("Background tint level");
        dash_tint_label.set_halign (Gtk.Align.START);
        dash_tint_value = new Gtk.SpinButton.with_range (0, 100, 1);
        ...
        dash_tint_value.set_halign (Gtk.Align.END);
        var dash_bwidth_label = new Gtk.Label.with_mnemonic ("Border width");
        dash_bwidth_label.set_halign (Gtk.Align.START);
        dash_bwidth_value = new Gtk.SpinButton.with_range (0, 100, 1);
        dash_bwidth_value.set_tooltip_text ("Set the border width of the dash and workspace panel");
        dash_bwidth_value.set_halign (Gtk.Align.END);

        var dash_bg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        dash_grid.attach_next_to (dash_bg_box, dash_bg_label, Gtk.PositionType.RIGHT, 1, 1);
        dash_grid.attach (dash_fg_label, 0, 1, 2, 1);
        dash_grid.attach_next_to (dash_fg_color, dash_fg_label, Gtk.PositionType.RIGHT, 1, 1);
        dash_grid.attach (dash_border_label, 0, 2, 2, 1);
        dash_grid.attach_next_to (dash_border_color, dash_border_label, Gtk.PositionType.RIGHT, 1, 1);
        dash_grid.attach (dash_tint_label, 0, 3, 2, 1);
        dash_grid.attach_next_to (dash_tint_value, dash_tint_label, Gtk.PositionType.RIGHT, 1, 1);
        dash_grid.attach (dash_bwidth_label, 0, 4, 2, 1);
        dash_grid.attach_next_to (dash_bwidth_value, dash_bwidth_label, Gtk.PositionType.RIGHT, 1, 1);

        // Menu
        var menu_bg_label = new Gtk.Label.with_mnemonic ("Background gradient");
        menu_bg_label.set_halign (Gtk.Align.START);
        menu_bg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) menu_bg1_color).set_use_alpha (true);
        menu_bg1_color.set_tooltip_text ("Set the background gradient start of the popup menu");
        menu_bg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) menu_bg2_color).set_use_alpha (true);
        menu_bg2_color.set_tooltip_text ("Set the background gradient end of the popup menu");
        var menu_fg_label = new Gtk.Label.with_mnemonic ("Text color");
        menu_fg_label.set_halign (Gtk.Align.START);
        menu_fg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) menu_fg_color).set_use_alpha (true);
        menu_fg_color.set_tooltip_text ("Set the text color of the popup menu");
        var menu_border_label = new Gtk.Label.with_mnemonic ("Border color");
        menu_border_label.set_halign (Gtk.Align.START);
        menu_border_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) menu_border_color).set_use_alpha (true);
        menu_border_color.set_tooltip_text ("Set the border color of the popup menu");
        var menu_arrow_label = new Gtk.Label.with_mnemonic ("Arrow pointer");
        menu_arrow_label.set_halign (Gtk.Align.START);
        menu_arrow_switch = new Gtk.Switch ();
        menu_arrow_switch.set_tooltip_text ("Enable/disable arrow pointer in the popup menu");
        menu_arrow_switch.set_halign (Gtk.Align.END);
        var menu_tint_label = new Gtk.Label.with_mnemonic ("Background tint level");
        menu_tint_label.set_halign (Gtk.Align.START);
        menu_tint_value = new Gtk.SpinButton.with_range (0, 100, 1);
        ...
        menu_tint_value.set_halign (Gtk.Align.END);
        var menu_bwidth_label = new Gtk.Label.with_mnemonic ("Border width");
        menu_bwidth_label.set_halign (Gtk.Align.START);
        menu_bwidth_value = new Gtk.SpinButton.with_range (0, 100, 1);
        menu_bwidth_value.set_tooltip_text ("Set the border width of the popup menu");
        menu_bwidth_value.set_halign (Gtk.Align.END);

        var menu_bg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        menu_grid.attach_next_to (menu_bg_box, menu_bg_label, Gtk.PositionType.RIGHT, 1, 1);
        menu_grid.attach (menu_fg_label, 0, 1, 2, 1);
        menu_grid.attach_next_to (menu_fg_color, menu_fg_label, Gtk.PositionType.RIGHT, 1, 1);
        menu_grid.attach (menu_border_label, 0, 2, 2, 1);
        menu_grid.attach_next_to (menu_border_color, menu_border_label, Gtk.PositionType.RIGHT, 1, 1);
        menu_grid.attach (menu_arrow_label, 0, 3, 2, 1);
        menu_grid.attach_next_to (menu_arrow_switch, menu_arrow_label, Gtk.PositionType.RIGHT, 1, 1);
        menu_grid.attach (menu_tint_label, 0, 4, 2, 1);
        menu_grid.attach_next_to (menu_tint_value, menu_tint_label, Gtk.PositionType.RIGHT, 1, 1);
        menu_grid.attach (menu_bwidth_label, 0, 5, 2, 1);
        menu_grid.attach_next_to (menu_bwidth_value, menu_bwidth_label, Gtk.PositionType.RIGHT, 1, 1);

        // Dialogs
        var dialog_bg_label = new Gtk.Label.with_mnemonic ("Background gradient");
        dialog_bg_label.set_halign (Gtk.Align.START);
        dialog_bg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) dialog_bg1_color).set_use_alpha (true);
        dialog_bg1_color.set_tooltip_text ("Set the background gradient start of the modal dialogs");
        dialog_bg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) dialog_bg2_color).set_use_alpha (true);
        dialog_bg2_color.set_tooltip_text ("Set the background gradient end of the modal dialogs");
        var dialog_fg_label = new Gtk.Label.with_mnemonic ("Text color");
        dialog_fg_label.set_halign (Gtk.Align.START);
        dialog_fg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) dialog_fg_color).set_use_alpha (true);
        dialog_fg_color.set_tooltip_text ("Set the text color of the modal dialogs");
        var dialog_heading_label = new Gtk.Label.with_mnemonic ("Heading color");
        dialog_heading_label.set_halign (Gtk.Align.START);
        dialog_heading_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) dialog_heading_color).set_use_alpha (true);
        dialog_heading_color.set_tooltip_text ("Set the text color of headings in the modal dialogs");
        var dialog_border_label = new Gtk.Label.with_mnemonic ("Border color");
        dialog_border_label.set_halign (Gtk.Align.START);
        dialog_border_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) dialog_border_color).set_use_alpha (true);
        dialog_border_color.set_tooltip_text ("Set the border color of the modal dialogs");
        var dialog_tint_label = new Gtk.Label.with_mnemonic ("Background tint level");
        dialog_tint_label.set_halign (Gtk.Align.START);
        dialog_tint_value = new Gtk.SpinButton.with_range (0, 100, 1);
        ...
        dialog_tint_value.set_halign (Gtk.Align.END);
        var dialog_bwidth_label = new Gtk.Label.with_mnemonic ("Border width");
        dialog_bwidth_label.set_halign (Gtk.Align.START);
        dialog_bwidth_value = new Gtk.SpinButton.with_range (0, 100, 1);
        dialog_bwidth_value.set_tooltip_text ("Set the border width of the modal dialogs");
        dialog_bwidth_value.set_halign (Gtk.Align.END);

        var dialog_bg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        dialog_grid.attach_next_to (dialog_bg_box, dialog_bg_label, Gtk.PositionType.RIGHT, 1, 1);
        dialog_grid.attach (dialog_fg_label, 0, 1, 2, 1);
        dialog_grid.attach_next_to (dialog_fg_color, dialog_fg_label, Gtk.PositionType.RIGHT, 1, 1);
        dialog_grid.attach (dialog_heading_label, 0, 2, 2, 1);
        dialog_grid.attach_next_to (dialog_heading_color, dialog_heading_label, Gtk.PositionType.RIGHT, 1, 1);
        dialog_grid.attach (dialog_border_label, 0, 3, 2, 1);
        dialog_grid.attach_next_to (dialog_border_color, dialog_border_label, Gtk.PositionType.RIGHT, 1, 1);
        dialog_grid.attach (dialog_tint_label, 0, 4, 2, 1);
        dialog_grid.attach_next_to (dialog_tint_value, dialog_tint_label, Gtk.PositionType.RIGHT, 1, 1);
        dialog_grid.attach (dialog_bwidth_label, 0, 5, 2, 1);
        dialog_grid.attach_next_to (dialog_bwidth_value, dialog_bwidth_label, Gtk.PositionType.RIGHT, 1, 1);

        // Gtk.Buttons
        var button_bg_label = new Gtk.Label.with_mnemonic ("Background gradient");
        button_bg_label.set_halign (Gtk.Align.START);
        button_bg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_bg1_color).set_use_alpha (true);
        button_bg1_color.set_tooltip_text ("Set the background gradient start of the buttons");
        button_bg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_bg2_color).set_use_alpha (true);
        button_bg2_color.set_tooltip_text ("Set the background gradient end of the buttons");
        var button_hoverbg_label = new Gtk.Label.with_mnemonic ("Hover background gradient");
        button_hoverbg_label.set_halign (Gtk.Align.START);
        button_hoverbg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_hoverbg1_color).set_use_alpha (true);
        button_hoverbg1_color.set_tooltip_text ("Set the background gradient start of the buttons in hover state");
        button_hoverbg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_hoverbg2_color).set_use_alpha (true);
        button_hoverbg2_color.set_tooltip_text ("Set the background gradient end of the buttons in hover state");
        var button_activebg_label = new Gtk.Label.with_mnemonic ("Active background gradient");
        button_activebg_label.set_halign (Gtk.Align.START);
        button_activebg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_activebg1_color).set_use_alpha (true);
        button_activebg1_color.set_tooltip_text ("Set the background gradient start of the buttons in active state");
        button_activebg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_activebg2_color).set_use_alpha (true);
        button_activebg2_color.set_tooltip_text ("Set the background gradient end of the buttons in active state");
        var button_fg_label = new Gtk.Label.with_mnemonic ("Text color");
        button_fg_label.set_halign (Gtk.Align.START);
        button_fg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_fg_color).set_use_alpha (true);
        button_fg_color.set_tooltip_text ("Set the text color of the buttons");
        var button_hoverfg_label = new Gtk.Label.with_mnemonic ("Hover text color");
        button_hoverfg_label.set_halign (Gtk.Align.START);
        button_hoverfg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_hoverfg_color).set_use_alpha (true);
        button_hoverfg_color.set_tooltip_text ("Set the text color of the buttons in hover state");
        var button_activefg_label = new Gtk.Label.with_mnemonic ("Active text color");
        button_activefg_label.set_halign (Gtk.Align.START);
        button_activefg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_activefg_color).set_use_alpha (true);
        button_activefg_color.set_tooltip_text ("Set the text color of the buttons in active state");
        var button_border_label = new Gtk.Label.with_mnemonic ("Border color");
        button_border_label.set_halign (Gtk.Align.START);
        button_border_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_border_color).set_use_alpha (true);
        button_border_color.set_tooltip_text ("Set the border color of the buttons");
        var button_hoverborder_label = new Gtk.Label.with_mnemonic ("Hover border color");
        button_hoverborder_label.set_halign (Gtk.Align.START);
        button_hoverborder_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_hoverborder_color).set_use_alpha (true);
        button_hoverborder_color.set_tooltip_text ("Set the border color of the buttons in hover state");
        var button_activeborder_label = new Gtk.Label.with_mnemonic ("Active border color");
        button_activeborder_label.set_halign (Gtk.Align.START);
        button_activeborder_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) button_activeborder_color).set_use_alpha (true);
        button_activeborder_color.set_tooltip_text ("Set the border color of the buttons in active state");
        var button_bold_label = new Gtk.Label.with_mnemonic ("Bold label");
        button_bold_label.set_halign (Gtk.Align.START);
        button_bold_switch = new Gtk.Switch ();
        button_bold_switch.set_tooltip_text ("Enable/disable bold label in the buttons");
        button_bold_switch.set_halign (Gtk.Align.END);

        var button_bg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        var button_hoverbg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        var button_activebg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        button_grid.attach_next_to (button_bg_box, button_bg_label, Gtk.PositionType.RIGHT, 1, 1);
        button_grid.attach (button_hoverbg_label, 0, 1, 2, 1);
        button_grid.attach_next_to (button_hoverbg_box, button_hoverbg_label, Gtk.PositionType.RIGHT, 1, 1);
        button_grid.attach (button_activebg_label, 0, 2, 2, 1);
        button_grid.attach_next_to (button_activebg_box, button_activebg_label, Gtk.PositionType.RIGHT, 1, 1);
        button_grid.attach (button_fg_label, 0, 3, 2, 1);
        button_grid.attach_next_to (button_fg_color, button_fg_label, Gtk.PositionType.RIGHT, 1, 1);
        button_grid.attach (button_hoverfg_label, 0, 4, 2, 1);
        button_grid.attach_next_to (button_hoverfg_color, button_hoverfg_label, Gtk.PositionType.RIGHT, 1, 1);
        button_grid.attach (button_activefg_label, 0, 5, 2, 1);
        button_grid.attach_next_to (button_activefg_color, button_activefg_label, Gtk.PositionType.RIGHT, 1, 1);
        button_grid.attach (button_border_label, 0, 6, 2, 1);
        button_grid.attach_next_to (button_border_color, button_border_label, Gtk.PositionType.RIGHT, 1, 1);
        button_grid.attach (button_hoverborder_label, 0, 7, 2, 1);
        button_grid.attach_next_to (button_hoverborder_color, button_hoverborder_label, Gtk.PositionType.RIGHT, 1, 1);
        button_grid.attach (button_activeborder_label, 0, 8, 2, 1);
        button_grid.attach_next_to (button_activeborder_color, button_activeborder_label, Gtk.PositionType.RIGHT, 1, 1);
        button_grid.attach (button_bold_label, 0, 9, 2, 1);
        button_grid.attach_next_to (button_bold_switch, button_bold_label, Gtk.PositionType.RIGHT, 1, 1);

        // Focused buttons
        var buttonfocus_bg_label = new Gtk.Label.with_mnemonic ("Background gradient");
        buttonfocus_bg_label.set_halign (Gtk.Align.START);
        buttonfocus_bg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_bg1_color).set_use_alpha (true);
        buttonfocus_bg1_color.set_tooltip_text ("Set the background gradient start of the focused buttons");
        buttonfocus_bg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_bg2_color).set_use_alpha (true);
        buttonfocus_bg2_color.set_tooltip_text ("Set the background gradient end of the focused buttons");
        var buttonfocus_hoverbg_label = new Gtk.Label.with_mnemonic ("Hover background gradient");
        buttonfocus_hoverbg_label.set_halign (Gtk.Align.START);
        buttonfocus_hoverbg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_hoverbg1_color).set_use_alpha (true);
        buttonfocus_hoverbg1_color.set_tooltip_text ("Set the background gradient start of the focused buttons in hover state");
        buttonfocus_hoverbg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_hoverbg2_color).set_use_alpha (true);
        buttonfocus_hoverbg2_color.set_tooltip_text ("Set the background gradient end of the focused buttons in hover state");
        var buttonfocus_activebg_label = new Gtk.Label.with_mnemonic ("Active background gradient");
        buttonfocus_activebg_label.set_halign (Gtk.Align.START);
        buttonfocus_activebg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_activebg1_color).set_use_alpha (true);
        buttonfocus_activebg1_color.set_tooltip_text ("Set the background gradient start of the focused buttons in active state");
        buttonfocus_activebg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_activebg2_color).set_use_alpha (true);
        buttonfocus_activebg2_color.set_tooltip_text ("Set the background gradient end of the focused buttons in active state");
        var buttonfocus_fg_label = new Gtk.Label.with_mnemonic ("Text color");
        buttonfocus_fg_label.set_halign (Gtk.Align.START);
        buttonfocus_fg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_fg_color).set_use_alpha (true);
        buttonfocus_fg_color.set_tooltip_text ("Set the text color of the focused buttons");
        var buttonfocus_hoverfg_label = new Gtk.Label.with_mnemonic ("Hover text color");
        buttonfocus_hoverfg_label.set_halign (Gtk.Align.START);
        buttonfocus_hoverfg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_hoverfg_color).set_use_alpha (true);
        buttonfocus_hoverfg_color.set_tooltip_text ("Set the text color of the focused buttons in hover state");
        var buttonfocus_activefg_label = new Gtk.Label.with_mnemonic ("Active text color");
        buttonfocus_activefg_label.set_halign (Gtk.Align.START);
        buttonfocus_activefg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_activefg_color).set_use_alpha (true);
        buttonfocus_activefg_color.set_tooltip_text ("Set the text color of the focused buttons in active state");
        var buttonfocus_border_label = new Gtk.Label.with_mnemonic ("Border color");
        buttonfocus_border_label.set_halign (Gtk.Align.START);
        buttonfocus_border_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_border_color).set_use_alpha (true);
        buttonfocus_border_color.set_tooltip_text ("Set the border color of the focused buttons");
        var buttonfocus_hoverborder_label = new Gtk.Label.with_mnemonic ("Hover border color");
        buttonfocus_hoverborder_label.set_halign (Gtk.Align.START);
        buttonfocus_hoverborder_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_hoverborder_color).set_use_alpha (true);
        buttonfocus_hoverborder_color.set_tooltip_text ("Set the border color of the focused buttons in hover state");
        var buttonfocus_activeborder_label = new Gtk.Label.with_mnemonic ("Active border color");
        buttonfocus_activeborder_label.set_halign (Gtk.Align.START);
        buttonfocus_activeborder_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) buttonfocus_activeborder_color).set_use_alpha (true);
        buttonfocus_activeborder_color.set_tooltip_text ("Set the border color of the focused buttons in active state");

        var buttonfocus_bg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        var buttonfocus_hoverbg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        var buttonfocus_activebg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        var buttonfocus_grid = new Gtk.Grid ();
        ...
        buttonfocus_grid.attach_next_to (buttonfocus_bg_box, buttonfocus_bg_label, Gtk.PositionType.RIGHT, 1, 1);
        buttonfocus_grid.attach (buttonfocus_hoverbg_label, 0, 1, 2, 1);
        buttonfocus_grid.attach_next_to (buttonfocus_hoverbg_box, buttonfocus_hoverbg_label, Gtk.PositionType.RIGHT, 1, 1);
        buttonfocus_grid.attach (buttonfocus_activebg_label, 0, 2, 2, 1);
        buttonfocus_grid.attach_next_to (buttonfocus_activebg_box, buttonfocus_activebg_label, Gtk.PositionType.RIGHT, 1, 1);
        buttonfocus_grid.attach (buttonfocus_fg_label, 0, 3, 2, 1);
        buttonfocus_grid.attach_next_to (buttonfocus_fg_color, buttonfocus_fg_label, Gtk.PositionType.RIGHT, 1, 1);
        buttonfocus_grid.attach (buttonfocus_hoverfg_label, 0, 4, 2, 1);
        buttonfocus_grid.attach_next_to (buttonfocus_hoverfg_color, buttonfocus_hoverfg_label, Gtk.PositionType.RIGHT, 1, 1);
        buttonfocus_grid.attach (buttonfocus_activefg_label, 0, 5, 2, 1);
        buttonfocus_grid.attach_next_to (buttonfocus_activefg_color, buttonfocus_activefg_label, Gtk.PositionType.RIGHT, 1, 1);
        buttonfocus_grid.attach (buttonfocus_border_label, 0, 6, 2, 1);
        buttonfocus_grid.attach_next_to (buttonfocus_border_color, buttonfocus_border_label, Gtk.PositionType.RIGHT, 1, 1);
        buttonfocus_grid.attach (buttonfocus_hoverborder_label, 0, 7, 2, 1);
        buttonfocus_grid.attach_next_to (buttonfocus_hoverborder_color, buttonfocus_hoverborder_label, Gtk.PositionType.RIGHT, 1, 1);
        buttonfocus_grid.attach (buttonfocus_activeborder_label, 0, 8, 2, 1);
        buttonfocus_grid.attach_next_to (buttonfocus_activeborder_color, buttonfocus_activeborder_label, Gtk.PositionType.RIGHT, 1, 1);

        // Entry
        var entry_bg_label = new Gtk.Label.with_mnemonic ("Background gradient");
        entry_bg_label.set_halign (Gtk.Align.START);
        entry_bg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) entry_bg1_color).set_use_alpha (true);
        entry_bg1_color.set_tooltip_text ("Set the background gradient start of the entry widget");
        entry_bg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) entry_bg2_color).set_use_alpha (true);
        entry_bg2_color.set_tooltip_text ("Set the background gradient end of the entry widget");
        var entry_fg_label = new Gtk.Label.with_mnemonic ("Text color");
        entry_fg_label.set_halign (Gtk.Align.START);
        entry_fg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) entry_fg_color).set_use_alpha (true);
        entry_fg_color.set_tooltip_text ("Set the text color of the entry widget");
        var entry_border_label = new Gtk.Label.with_mnemonic ("Border color");
        entry_border_label.set_halign (Gtk.Align.START);
        entry_border_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) entry_border_color).set_use_alpha (true);
        entry_border_color.set_tooltip_text ("Set the border color of the entry widget");
        var entry_shadow_label = new Gtk.Label.with_mnemonic ("Inset shadow");
        entry_shadow_label.set_halign (Gtk.Align.START);
        entry_shadow_switch = new Gtk.Switch ();
        entry_shadow_switch.set_tooltip_text ("Enable/disable inset shadow in the entry widget");
        entry_shadow_switch.set_halign (Gtk.Align.END);

        var entry_bg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        entry_grid.attach_next_to (entry_bg_box, entry_bg_label, Gtk.PositionType.RIGHT, 1, 1);
        entry_grid.attach (entry_fg_label, 0, 1, 2, 1);
        entry_grid.attach_next_to (entry_fg_color, entry_fg_label, Gtk.PositionType.RIGHT, 1, 1);
        entry_grid.attach (entry_border_label, 0, 2, 2, 1);
        entry_grid.attach_next_to (entry_border_color, entry_border_label, Gtk.PositionType.RIGHT, 1, 1);
        entry_grid.attach (entry_shadow_label, 0, 3, 2, 1);
        entry_grid.attach_next_to (entry_shadow_switch, entry_shadow_label, Gtk.PositionType.RIGHT, 1, 1);

        // Miscellaneous
        var misc_runningbg_label = new Gtk.Label.with_mnemonic ("Background gradient for running apps");
        misc_runningbg_label.set_halign (Gtk.Align.START);
        misc_runningbg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) misc_runningbg1_color).set_use_alpha (true);
        misc_runningbg1_color.set_tooltip_text ("Set the background gradient start for the icons of running apps");
        misc_runningbg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) misc_runningbg2_color).set_use_alpha (true);
        misc_runningbg2_color.set_tooltip_text ("Set the background gradient end for the icons of running apps");
        var misc_separator_label = new Gtk.Label.with_mnemonic ("Separator gradient");
        misc_separator_label.set_halign (Gtk.Align.START);
        misc_separator1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) misc_separator1_color).set_use_alpha (true);
        misc_separator1_color.set_tooltip_text ("Set the gradient color start of separators");
        misc_separator2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) misc_separator2_color).set_use_alpha (true);
        misc_separator2_color.set_tooltip_text ("Set the gradient color end of separators");
        var misc_tooltipbg_label = new Gtk.Label.with_mnemonic ("Tooltip background gradient");
        misc_tooltipbg_label.set_halign (Gtk.Align.START);
        misc_tooltipbg1_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) misc_tooltipbg1_color).set_use_alpha (true);
        misc_tooltipbg1_color.set_tooltip_text ("Set the gradient color start of tooltips");
        misc_tooltipbg2_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) misc_tooltipbg2_color).set_use_alpha (true);
        misc_tooltipbg2_color.set_tooltip_text ("Set the gradient color end of tooltips");
        var misc_tooltipfg_label = new Gtk.Label.with_mnemonic ("Tooltip text color");
        misc_tooltipfg_label.set_halign (Gtk.Align.START);
        misc_tooltipfg_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) misc_tooltipfg_color).set_use_alpha (true);
        misc_tooltipfg_color.set_tooltip_text ("Set the text color of tooltips");
        var misc_tooltipborder_label = new Gtk.Label.with_mnemonic ("Tooltip border color");
        misc_tooltipborder_label.set_halign (Gtk.Align.START);
        misc_tooltipborder_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) misc_tooltipborder_color).set_use_alpha (true);
        misc_tooltipborder_color.set_tooltip_text ("Set the border color of tooltips");
        var misc_insensitive_label = new Gtk.Label.with_mnemonic ("Insensitive text color");
        misc_insensitive_label.set_halign (Gtk.Align.START);
        misc_insensitive_color = new Gtk.ColorButton ();
        ((Gtk.ColorChooser) misc_insensitive_color).set_use_alpha (true);
        misc_insensitive_color.set_tooltip_text ("Set the text color of insensitive and faded items");

        var misc_runningbg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        var misc_separator_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        var misc_tooltipbg_box = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 0);
        ...
        misc_grid.attach_next_to (misc_runningbg_box, misc_runningbg_label, Gtk.PositionType.RIGHT, 1, 1);
        misc_grid.attach (misc_separator_label, 0, 1, 2, 1);
        misc_grid.attach_next_to (misc_separator_box, misc_separator_label, Gtk.PositionType.RIGHT, 1, 1);
        misc_grid.attach (misc_tooltipbg_label, 0, 2, 2, 1);
        misc_grid.attach_next_to (misc_tooltipbg_box, misc_tooltipbg_label, Gtk.PositionType.RIGHT, 1, 1);
        misc_grid.attach (misc_tooltipfg_label, 0, 3, 2, 1);
        misc_grid.attach_next_to (misc_tooltipfg_color, misc_tooltipfg_label, Gtk.PositionType.RIGHT, 1, 1);
        misc_grid.attach (misc_tooltipborder_label, 0, 4, 2, 1);
        misc_grid.attach_next_to (misc_tooltipborder_color, misc_tooltipborder_label, Gtk.PositionType.RIGHT, 1, 1);
